...
class Notebook extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      url_sub: 'https://m.aihuishou.com/portal-api/product/category-brands/5',
      url_sub_main: '/dgfile/notebook.json',
      list_sub: [],
      list_sub_main: []
    }
  }
      ...
      <Fragment>
        ...
        <div className="category_main">
          <ul className="title-shop">
            ...
            <li>
              <NavLink to="/choose1" activeClassName="yellow">卖笔记本</NavLink>
            </li>
            <li>
              <NavLink to="/choose2" >卖平板</NavLink>
            </li>
          </ul>
